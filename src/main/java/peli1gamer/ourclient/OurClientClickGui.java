    ...
    public boolean keyPressed(KeyEvent event) {
        try {
            ...
            if (key == GLFW.GLFW_KEY_UP && !modules.isEmpty()) {
                ...
                ensureSelectedVisible(modules); return true;
            }
            ...
            if (key == GLFW.GLFW_KEY_PAGEUP) {
                moduleScroll -= viewportHeight() * .8; clampScroll(modules.size()); return true;
            }
            ...
            if (key == GLFW.GLFW_KEY_END && !modules.isEmpty()) {
                selectedIndex = modules.size() - 1; ensureSelectedVisible(modules); return true;
            }
