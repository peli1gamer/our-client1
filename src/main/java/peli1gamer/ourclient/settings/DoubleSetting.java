...
public final class DoubleSetting extends Setting<Double> {
    ...
    @Override protected Double sanitize(Double value) {
        double v = value == null || !Double.isFinite(value) ? min : value;
    ...
    public static final class Builder {
        ...
        public DoubleSetting build() { return new DoubleSetting(this); }
    }
}
